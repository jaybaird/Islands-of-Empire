package net.flashpunk
{
	...
	public class Screen
	{
		...
		public function set filters(value:Array):void { _sprite.filters = value; }
		...
		// Screen infromation.
		/** @private */ protected var _sprite:Sprite = new Sprite;
		/** @private */ protected var _mask:DisplayObject;
		/** @private */ protected var _bitmap:Vector.<Bitmap> = new Vector.<Bitmap>(2);
		/** @private */ protected var _current:int = 0;
		/** @private */ protected var _matrix:Matrix = new Matrix;
		/** @private */ protected var _x:int;
		/** @private */ protected var _y:int;
		/** @private */ protected var _width:uint;
		/** @private */ protected var _height:uint;
		/** @private */ protected var _originX:int;
		/** @private */ protected var _originY:int;
		/** @private */ protected var _scaleX:Number = 1;
		/** @private */ protected var _scaleY:Number = 1;
		/** @private */ protected var _scale:Number = 1;
		/** @private */ protected var _angle:Number = 0;
		/** @private */ protected var _color:uint = 0x202020;
	}
}